...
# 2. Function to generate the HTML content
def get_khushi_html_content() -> str:
    """Generates the full HTML content for the love message page with a music control."""
        ...
        <html>
            <head>
                ...
                <style>
                    ...
                    .play-btn {
                        ...
                        font-weight: 700;
                        cursor: pointer;
                        margin: 30px auto 10px auto; /* Centered margin */
                    ...
                    /* --- Floating Heart Styles (existing) --- */
                    .heart {
                        position: fixed;
            ...
            <body>
                <div class="content-box">
                    ...
                    <button id="music-button" class="play-btn">Click to Play Our Song 🎶</button> 
                ...
                <!-- UPDATED: Removed 'autoplay', added 'id' for JavaScript control -->
                <audio id="romantic-song" loop>
                    <source src="https://www.bensound.com/bensound-music/bensound-romantic.mp3" type="audio/mpeg">
                </audio>

                <script>
                    // --- Typing Effect Script (existing) ---
                    ...
                    button.addEventListener('click', () => {
                        if (isPlaying) {
                            audio.pause();
                            button.innerHTML = 'Click to Play Our Song 🎶';
                        } else {
                            // Attempt to play the audio. This MUST be inside a user-initiated event.
                            audio.play().then(() => {
                                // Successfully started playing
                                button.innerHTML = 'Pause Song ⏸️';
                                isPlaying = true;
                            }).catch(error => {
                                // Handle case where play() fails (shouldn't happen on user click, but good practice)
                                console.error("Error playing audio:", error);
                                button.innerHTML = 'Could Not Play Song 😔';
                                isPlaying = false;
                            });
                        }
                    });

                    // --- Floating Hearts Script (existing) ---
