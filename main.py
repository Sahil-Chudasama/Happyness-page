    ...
    html_content = textwrap.dedent("""
        <html>
            ...
            <body>
                ...
                <!-- Audio element now points to the uploaded file: /static/adio.mp3 -->
                <audio id="romantic-song" preload="auto" style="display: none;">
                ...
                <script>
                    ...
                    button.addEventListener('click', () => {
                        if (isPlaying) {
                            ...
                            // Play must be inside a user-initiated event like click
                            audio.play().then(() => {
                                button.innerHTML = 'Pause Song ⏸️';
                                isPlaying = true;
                            }).catch(error => {
                                console.error("Error playing audio. Is the file path correct?", error);
                    ...
                    // Add listener to reset button when song ends
                    audio.addEventListener('ended', () => {
                        button.innerHTML = 'Replay Song 🎶';
                        isPlaying = false;
                    });
