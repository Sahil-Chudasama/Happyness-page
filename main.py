...
# 2. CRITICAL: Mount the static directory to serve adio.mp3 and proposal_bg.jpg
...
<html>
    <head>
        ...
        <style>
            ...
            body {
                ...
                background-image: url('/static/proposal_bg.jpg'); /* Your JPEG Image */
                background-size: cover;
                background-position: center bottom; /* Focus on the silhouette */
                background-attachment: fixed;
                background-color: #000033; /* Dark fallback color */
            }
            .content-box {
                /* Transparent background to make text readable over the dark image */
    ...
    <body>
        <div class="content-box">
            ...
            <p>
                My heart recognized you long before I knew your name. <br>
                **I love you, Khushi, now and until infinity.** 💍
            </p>
        </div>
