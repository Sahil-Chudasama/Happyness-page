...
from fastapi.staticfiles import StaticFiles  # Essential for /static/adio.mp3

app = FastAPI()

# Mount the static directory to serve your song
    ...
    <head>
        ...
        <style>
            :root {
                ...
                --background-light: #fff0f5; /* Lavender Blush, for the soft background */
            }
            body {
                /* REVERTED TO ORIGINAL GRADIENT BACKGROUND */
            ...
            .content-box {
                /* Simple, clean white box over the gradient */
